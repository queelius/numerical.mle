...
An R package providing numerical maximum likelihood estimation (MLE) solvers with a clean, composable API.
...
- **Function transformers**: Subsampling (stochastic gradient) and penalties (L1/L2/elastic net)
